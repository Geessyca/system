...
import SistemaGrafica.ServicosPersonalizados.Handler;

class ServicosImpressos  extends JDialog{
	JButton jbtCadastrar1, jbtFechar1;
    JLabel jlDes,jlNumReg,jlPreco, jlQuant;
	JTextField jtfDes, jtfNumReg,jtfPreco, jtfQuant;
	Main mn;
    public ServicosImpressos(Main r) {
        this.mn = r;
        getContentPane().setLayout(null);
        Handler obj = new Handler();
        setTitle("Cadastro de Serviços Impressos");
